    ...
    return (
      <nav class>
        <ul class="list-none space-y-0">
          ...
          <li>
            <Link 
              className="flex items-center p-1 rounded hover:bg-grey-200 active:bg-grey-200"
              to="/">
                <svg 
                  width="16" 
                  height="16" 
                  ...
                  <defs>
                    <radialGradient 
                      ...
                      gradientTransform="rotate(-128.458 6.894 4.064) scale(15.8108 23.3893)"
                    >
                ...
                <svg 
                  ...
                  <defs>
                    <radialGradient 
                      ...
                      r="1" 
                      gradientUnits="userSpaceOnUse" 
                      gradientTransform="rotate(-122.957 7.714 4.66) scale(18.0755 25.0622)"
                    >
                    <stop stop-color="#E6FFFC"/>
                    <stop offset="1" stop-color="#07BEB8"/>
                    </radialGradient>
                ...
                >
                  ...
                  <defs>
                    <radialGradient 
                      ...
                      r="1" 
                      gradientUnits="userSpaceOnUse" 
                      gradientTransform="matrix(-9.83333 -15.03091 20.91676 -13.6839 8 13.685)">
                      <stop stop-color="#E6FFFC"/>
                      <stop offset="1" stop-color="#07BEB8"/>
                    </radialGradient>
                  </defs>
                  ...
                  <svg 
                    ...
                    <defs>
                      <radialGradient 
                        ...
                        r="1" 
                        gradientUnits="userSpaceOnUse" 
                        gradientTransform="rotate(-122.133 7.736 4.645) scale(17.9101 24.5031)">
                        <stop stop-color="#E6FFFC"/>
                        <stop offset="1" stop-color="#07BEB8"/>
                      </radialGradient>
                      <radialGradient 
