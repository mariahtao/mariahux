            ...
            <div className="contents">
              <li className="flex-inital items-center md:flex-none">
                ...
                >
                  ...
                  <span class="ml-0 md:ml-3 hidden md:inline">Work</span>
                </Link>
              </li>
              <li className="flex-inital items-center md:flex-none">
                <Link 
                ...
                >
                  ...
                  <span class="ml-0 md:ml-3 hidden md:inline">About</span>
                </Link>
              </li>
              <li className="flex-inital items-center md:flex-none">
                ...
                >
                  ...
                  <span class="ml-0 md:ml-3 hidden md:inline">Email</span>
                  </a>
              </li>
              <li className="flex-inital items-center md:flex-none">
                ...
                >
                  ...
                  <span class="ml-0 md:ml-3 hidden md:inline">Resume</span>
                </a>
              </li>
              <li className="flex-inital items-center md:flex-none">
                ...
                >
                  ...
                  <span class="ml-0 md:ml-3 hidden md:inline">LinkedIn</span>
                </a>
              </li>
            </div>
          </div>
