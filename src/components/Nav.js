...
const Nav = () => {
    return (
      <nav class="block fixed inset-x-0 sm:inset-x-auto h-12 sm:h-full z-10 sm:w-48 w-full px-8 p-2 sm:p-0 sm:px-0 sm:mb-12 bg-grey-100/85 sm:bg-transparent backdrop-blur-3xl">
        <ul class="list-none sm:mb-12 sm:space-y-1 h-full flex flex-row sm:flex-col justify-between">
            ...
            <div className="contents">
              <li className="flex-inital items-center sm:flex-none">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                    <path fill-rule="evenodd" d="M2.245 1.042C1.005 1.042 0 2.047 0 3.287v11.837c0 1.24 1.005 2.245 2.245 2.245h15.51c1.24 0 2.245-1.005 2.245-2.245V4.919c0-1.24-1.005-2.245-2.245-2.245H8.769a1.02 1.02 0 0 1-.549-.16L6.464 1.394c-.361-.23-.779-.352-1.207-.352H2.245zm-1.02 2.245a1.02 1.02 0 0 1 1.02-1.02h3.012a1.02 1.02 0 0 1 .549.16l1.757 1.121c.361.23.779.352 1.207.352h8.986a1.02 1.02 0 0 1 1.02 1.02v1.837H1.224V3.287zm0 4.694v7.143a1.02 1.02 0 0 0 1.02 1.02h15.51a1.02 1.02 0 0 0 1.02-1.02V7.98H1.224z" fill="url(#A)"/>
                    <defs><radialGradient id="A" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(10 14.9872) rotate(-128.458) scale(19.7635 29.2366)"><stop stop-color="#e6fffc"/><stop offset="1" stop-color="#07beb8"/></radialGradient></defs>
                  </svg>
                  <span class="hide">Work</span>
                </Link>
              </li>
              <li className="flex-inital items-center sm:flex-none">
                <Link 
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                    ...
                    <path fill-rule="evenodd" d="M20 10c0 5.523-4.477 10-10 10S0 15.523 0 10 4.477 0 10 0s10 4.477 10 10zM2.775 14.937C3.656 13.531 6.557 12.5 10 12.5s6.344 1.031 7.226 2.437A8.71 8.71 0 0 0 18.75 10a8.75 8.75 0 1 0-17.5 0 8.71 8.71 0 0 0 1.525 4.937z" fill="url(#A)"/>
                    <defs><radialGradient id="A" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(10 17.0833) rotate(-122.957) scale(22.5943 31.3277)"><stop stop-color="#e6fffc"/><stop offset="1" stop-color="#07beb8"/></radialGradient></defs>
                  </svg>
              ...
              <li className="flex-inital items-center sm:flex-none">
                <a href="mailto:mariahtao@gmail.com" 
                  class="flex items-center p-1.5 sm:p-1 rounded hover:bg-grey-300 transition-all duration-500 ease-in-out"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                    ...
                    <defs><radialGradient id="A" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(10 17.1057) rotate(-123.193) scale(22.4521 31.244)"><stop stop-color="#e6fffc"/><stop offset="1" stop-color="#07beb8"/></radialGradient></defs>
                  </svg>
              ...
              <li className="flex-inital items-center sm:flex-none">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                    ...
                    <defs><radialGradient id="A" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(9.896 17.0833) rotate(-122.133) scale(22.3877 30.6289)"><stop stop-color="#e6fffc"/><stop offset="1" stop-color="#07beb8"/></radialGradient></defs>
                  </svg> 
