...
const CardWork = ({ children, href }) => {
  return (
    <div class="block p-4 space-y-4 bg-grey-200 rounded-md border border-grey-300 shadow-xl shadow-aqua-400/5">
      ...
      <button type="button" class="text-white bg-grey-400 hover:bg-grey-100 focus:ring-2 focus:ring-aqua-100 font-medium rounded text-base px-4 py-2 text-center inline-flex items-center shadow-lg shadow-aqua-400/10">
        View
