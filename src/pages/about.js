...
const AboutPage = () => {
  return (
    <Layout pageTitle="About me" title="Mariah Tao | About">
      <div className="space-y-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="md:col-span-1 lg:col-span-2">
            <text className="gradient">SHE / HER / HERS</text>
            <p className="mt-8">
              Hey there 👋🏼 . I am a Seattleite now living in Arizona, originally
              from California.
            </p>
            <p>
              In my free time, you can find me spending time with my family and
              friends. I enjoy yoga, crypto, streetwear fashion, and
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-5">
            <CardImg>
              ...
              >
                <g clipPath="url(#a)">
                  ...
                  />
                  <path
                    d="M4.002 12c0-2.208 1.792-4 4-4h4v8h-4c-2.208 0-4-1.792-4-4z"
                    fill="#A259FF"
                  />
                  <path
                    d="M4.002 4c0-2.208 1.792-4 4-4h4v8h-4c-2.208 0-4-1.792-4-4z"
                    fill="#F24E1E"
                  />
                  <path
                    d="M12.002 0h4c2.208 0 4 1.792 4 4s-1.792 4-4 4h-4V0z"
                    fill="#FF7262"
                  />
                  <path
                    d="M20.002 12c0 2.208-1.792 4-4 4s-4-1.792-4-4 1.792-4 4-4 4 1.792 4 4z"
                    fill="#1ABCFE"
                  />
                </g>
                <defs>
            ...
            <CardImg>
              ...
              >
                <path
                  d="m2.744 22.115-.743-19.81a1.207 1.207 0 0 1 1.13-1.25L19.981.003a1.207 1.207 0 0 1 1.282 1.205v21.586A1.207 1.207 0 0 1 20.003 24l-16.107-.724a1.207 1.207 0 0 1-1.152-1.16z"
                  fill="#fff"
                />
                <path
                  d="m2.744 22.115-.743-19.81a1.207 1.207 0 0 1 1.13-1.25L19.981.003a1.207 1.207 0 0 1 1.282 1.205v21.586A1.207 1.207 0 0 1 20.003 24l-16.107-.724a1.207 1.207 0 0 1-1.152-1.16z"
            ...
            <CardImg>
              ...
              >
                <path
                  d="M5.226 1.714 11.976 1l6.75.714 5.226 7.015-11.976 13.945L0 8.73l5.226-7.015z"
                  fill="#FDB300"
                />
                <path
                  d="m4.85 8.729 7.126 13.945L0 8.73h4.85zM19.1 8.729l-7.124 13.945L23.952 8.73H19.1z"
                  fill="#EA6C00"
                />
                <path
                  d="M4.85 8.729H19.1l-7.124 13.945L4.85 8.73z"
                  fill="#FDAD00"
                />
                <path
                  d="m11.976 1-6.75.714-.375 7.015L11.976 1zM11.976 1l6.75.714.375 7.015L11.976 1z"
                  fill="#FDD231"
                />
                <path
                  d="m23.952 8.729-5.226-7.015.375 7.015h4.85zM0 8.729l5.226-7.015-.375 7.015H0z"
                  fill="#FDAD00"
                />
            ...
            <CardImg>
              ...
              >
                <path
                  d="M12.7 9.1a1.2 1.2 0 1 0 2.4 0 1.2 1.2 0 1 0-2.4 0z"
                  fill="url(#A)"
                />
                <path
                  d="M10.3 5.9a1.2 1.2 0 0 0 2.4 0 1.2 1.2 0 0 0-2.4 0z"
                  fill="url(#A)"
                />
                <path
                  d="M5.1 7.9a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 1 0 0-2.4z"
                  fill="url(#A)"
                />
                <path
                  d="M7.5 7.1a1.2 1.2 0 0 0 0-2.4 1.2 1.2 0 0 0 0 2.4z"
                  fill="url(#A)"
                />
                <path
                  fillRule="evenodd"
            ...
            <CardImg>
              ...
              >
                <path
                  ...
                  fill="url(#paint0_linear_365_240389)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_365_240389"
                    x1="0"
                    y1="-8"
                    x2="24"
                    y2="32"
