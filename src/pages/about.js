      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-5">
          <CardImg>
            ...
            <span>
              <h5 class="w-full text-sb">Figma</h5>
            </span>
          </CardImg>
          <CardImg>
            ...
            <span>
              <h5 class="w-full text-sb">Storybook</h5>
            </span>
          </CardImg>
          <CardImg>
            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>
              <h5 class="w-full text-sb">Sketch</h5>
            </span>
          </CardImg>
          <CardImg>
            ...
            <span>
              <h5 class="w-full text-sb">Tokens</h5>
            </span>
          </CardImg>
          <CardImg>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
            ...
            <span>
              <h5 class="w-full text-sb">Tailwind</h5>
            </span>
          </CardImg>
          <CardImg>
            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>
              <h5 class="w-full text-sb">react.js</h5>
            </span>
          </CardImg>
          <CardImg>
            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>
              <h5 class="w-full text-sb">SASS</h5>
            </span>
          </CardImg>
        </div>
      </div>
