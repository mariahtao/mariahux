      ...
      <div className="grid grid-cols-3 gap-6 mt-12">
        <CardList>
          <ul class="list-none mb-0">
            ...
            <li class="w-full py-1 text-aqua-500 text-sb">HBAR</li>
            <li class="w-full py-1 text-aqua-500 text-sb">CRV</li>
            <li class="w-full mb-0 text-aqua-500 text-sb">ALGO</li>
          </ul>
        </CardList>
        <CardList>
          <ul class="list-none mb-0">
            <li class="w-full py-1 text-grey-900">Streetwear staples</li>
            <li class="w-full py-1 text-aqua-500 text-sb">ksubi bucket bag</li>
            <li class="w-full py-1 text-aqua-500 text-sb">Bao Bao matte tote</li>
            <li class="w-full mb-0 text-aqua-500 text-sb">AJ1 chicago red</li>
          </ul>
        </CardList>
        <CardList>
          <ul class="list-none mb-0">
            <li class="w-full py-1 text-grey-900">Favorite animes</li>
            <li class="w-full py-1 text-aqua-500 text-sb">Demon Slayer</li>
            <li class="w-full py-1 text-aqua-500 text-sb">Inuyasha</li>
            <li class="w-full mb-0 text-aqua-500 text-sb">Deathnote</li>
          </ul>
        </CardList>
      </div>
      <div className="mt-12">
        ...
        <div className="grid grid-cols-4 gap-6 mt-5">
          <CardImg>
            ...
            <span>
              <h5 class="w-full text-aqua-500 text-sb">Figma</h5>
            </span>
          </CardImg>
          <CardImg>
            ...
            <span>
              <h5 class="w-full text-aqua-500 text-sb">Storybook</h5>
            </span>
          </CardImg>
          <CardImg>
            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>
              <h5 class="w-full text-aqua-500 text-sb">Sketch</h5>
            </span>
          </CardImg>
          <CardImg>
            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <CardImg>
            ...
            <span>
              <h5 class="w-full text-aqua-500 text-sb">react.js</h5>
            </span>
          </CardImg>
          <CardImg>
            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>
              <h5 class="w-full text-aqua-500 text-sb">SASS</h5>
            </span>
          </CardImg>
        </div>
      </div>
